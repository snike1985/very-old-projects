            ...
            return {
                ...
                addWraper: function(){
                    ...
                    self.obj.find( 'option' ).each( function(){
                        ...
                        if( curItem.attr( 'selected' ) == 'selected' ){
                            ...
                            if (self.obj.hasClass('pic-select')) {
                                picWay = curItem.attr('date-src');
                                flag = true;
                            }
                        }
                    } );
                    ...
                    if (self.obj.hasClass('pic-select')) {
                        if (flag) {
                            self.text.prepend('<img src="'+ picWay +'" alt="">');
                        } else {
                            self.text.prepend('<img src="'+ self.obj.find( 'option').eq(0).attr('date-src') +'" alt="">');
                        }
                    }
                },
                showPopup: function(){
                    ...
                    self.obj.find( 'option' ).each( function(i){
                        ...
                        if( i == curIndex ){
                            list.append( '<li class="active"><img src="'+ self.obj.find( 'option').eq(i).attr('date-src') +'" alt="">' + curItem.text() + '</li>' );
                        } else {
                            list.append( '<li><img src="'+ self.obj.find( 'option').eq(i).attr('date-src') +'" alt="">' + curItem.text() + '</li>' );
                        }
                ...
                controls: function() {
                    self.obj.on( 'change', function() {
                        ...
                        self.text.prepend('<img src="'+ self.obj.find( 'option:selected').attr('date-src') +'" alt="">');
                    } );
