    ...
    core: function () {
        ...
        return {
            ...
            addControls: function () {
                ...
                self.btnPrev = $('<div class="' + self.className + '__btn ' + self.className + '__btn_prev"></div>');
                self.btnNext = $('<div class="' + self.className + '__btn ' + self.className + '__btn_next"></div>');
                ...
                self.obj.append('<div class="slider__count"><span>1</span>/<span>' + self.points.length + '</span></div>');
            ...
            slideTo: function (index, direction) {
                ...
                $('.slider__count').find('span:first-child').text(newIndex+1);
            ...
            slideToNext: function (delta) {
                ...
                if (( Math.abs(delta) / self.width ) > 0.2) {
                    ...
                    $('.slider__count').find('span:first-child').text(self.active+1);
