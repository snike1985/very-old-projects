$(function(){
    ...
    $.each( catalogSlider, function () {
        var curItem = $( this );

        new SliderSingle( {
            obj: curItem,
            wrap: curItem.find( '.slider-catalog__wrap' ),
            slides: curItem.find( '.catalog'),
            duration: 300,
            delay: 5000
        } );
    });
            ...
            addEvents: function () {
                ...
                self.window.on({
                    resize: function () {
                        ...
                        self.slides.eq( self.active).addClass('active');
                    }
                });
