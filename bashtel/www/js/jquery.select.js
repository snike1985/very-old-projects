        ...
        core: function(){
            ...
            return {
                ...
                showPopup: function(){
                    ...
                    console.log(self.wrap.parents('.call-back__info_time'))

                    if (self.wrap.parents('.call-back__info_time')) {
                        self.popup = $( '<div class="ares-select__popup time__popup" id="ares-select__popup' + id + '"></div>' );
                    } else {
