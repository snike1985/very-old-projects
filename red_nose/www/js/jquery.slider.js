$(function(){
    ...
    var slider = $( '.thanks-slider');

    slider.each(function(){
        new AresSlider1( {
            obj: slider,
            items: slider.find( '.thanks-slider__item' ),
            btnNext: slider.find( '.thanks-slider__next' ),
            btnPrev: slider.find('.thanks-slider__prev'),
            duration: 10000
        } );
    });
});
            ...
            return {
                build: function(){
                    var count = elems.items.length,
                        i,
                        points = $( '<ul class="thanks-slider__points"></ul>');
