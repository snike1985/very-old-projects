$(function(){
    $( 'select' ).each( function(){
        var curItem = $( this );
        if ( curItem.parent('.ganre-wrap').length ){
    ...
    core: function(){
        ...
        return {
            ...
            showPopup: function(){
                ...
                if ( self.arrows ){
                    var arrowBtn = self.popup.append(' <a class="scroll-top"></a><a class="scroll-bottom"></a>');
                    arrowBtn.on({
                        click: function(){
                            return false
                        }
            ...
            hidePopup: function(){
                ...
                self.wrap.css('background-color','transparent')
            },
            controls: function() {
                    ...
                    self.wrap.on( {
                        'click': function(event){
                            ...
                            if( self.opened ){
                                ...
                                self.core.showPopup();
                                self.wrap.css('background-color','rgb(53,42,37)')
                            }
